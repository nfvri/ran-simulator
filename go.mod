...
require (
	...
	github.com/nfvri/onos-api/go v0.0.0-20241122092746-f9291ad90ac9
	...
	github.com/onosproject/onos-e2-sm/servicemodels/e2sm_rc_pre_go v0.8.43
	github.com/onosproject/onos-e2t v0.11.23
