...
var nrBands = map[string]BandNR{
	...
	"n1":   {"n1", 1920, 1980, 2110, 2170, "FDD", 384000, 396000, 422000, 434000},
	"n2":   {"n2", 1850, 1910, 1930, 1990, "FDD", 370000, 382000, 386000, 398000},
	"n3":   {"n3", 1710, 1785, 1805, 1880, "FDD", 342000, 357000, 361000, 376000},
	"n5":   {"n5", 824, 849, 869, 894, "FDD", 164800, 169800, 173800, 178800},
	"n7":   {"n7", 2500, 2570, 2620, 2690, "FDD", 500000, 514000, 524000, 538000},
	"n8":   {"n8", 880, 915, 925, 960, "FDD", 176000, 183000, 185000, 192000},
	"n12":  {"n12", 699, 716, 729, 746, "FDD", 139800, 143200, 145800, 149200},
	"n13":  {"n13", 777, 787, 746, 756, "FDD", 155400, 157400, 149200, 151200},
	"n14":  {"n14", 788, 798, 758, 768, "FDD", 157600, 159600, 151600, 153600},
	"n18":  {"n18", 815, 830, 860, 875, "FDD", 163000, 166000, 172000, 175000},
	"n20":  {"n20", 832, 862, 791, 821, "FDD", 166400, 172400, 158200, 164200},
	"n24":  {"n24", 1626.5, 1660.5, 1525, 1559, "FDD", 325300, 332100, 305000, 311800},
	"n25":  {"n25", 1850, 1915, 1930, 1995, "FDD", 370000, 383000, 386000, 399000},
	"n26":  {"n26", 814, 849, 859, 894, "FDD", 162800, 169800, 171800, 178800},
	"n28":  {"n28", 703, 748, 758, 803, "FDD", 140600, 149600, 151600, 160600},
	"n29":  {"n29", 0, 0, 717, 728, "SDL", 0, 0, 143400, 145600},
	"n30":  {"n30", 2305, 2315, 2350, 2360, "FDD", 461000, 463000, 470000, 472000},
	"n31":  {"n31", 452.5, 457.5, 462.5, 467.5, "TDD", 90500, 91500, 92500, 93500},
	"n34":  {"n34", 2010, 2025, 2010, 2025, "TDD", 402000, 405000, 402000, 405000},
	"n38":  {"n38", 2570, 2620, 2570, 2620, "TDD", 514000, 524000, 514000, 524000},
	"n39":  {"n39", 1880, 1920, 1880, 1920, "TDD", 376000, 384000, 376000, 384000},
	"n40":  {"n40", 2300, 2400, 2300, 2400, "TDD", 460000, 480000, 460000, 480000},
	"n41":  {"n41", 2496, 2690, 2496, 2690, "TDD", 499200, 537999, 499200, 537999},
	"n46":  {"n46", 5150, 5925, 5150, 5925, "TDD", 743334, 795000, 743334, 795000},
	"n47":  {"n47", 5855, 5925, 5855, 5925, "TDD", 790334, 795000, 790334, 795000},
	"n48":  {"n48", 3550, 3700, 3550, 3700, "TDD", 636667, 646666, 636667, 646666},
	"n50":  {"n50", 1432, 1517, 1432, 1517, "TDD", 286400, 303400, 286400, 303400},
	"n51":  {"n51", 1427, 1432, 1427, 1432, "TDD", 285400, 286400, 285400, 286400},
	"n53":  {"n53", 2483.5, 2495, 2483.5, 2495, "TDD", 496700, 499000, 496700, 499000},
	"n54":  {"n54", 1670, 1675, 1670, 1675, "TDD", 334000, 335000, 334000, 335000},
	"n65":  {"n65", 1920, 2010, 2110, 2200, "FDD", 384000, 402000, 422000, 440000},
	"n66":  {"n66", 1710, 1780, 2110, 2200, "FDD", 342000, 356000, 422000, 440000},
	"n67":  {"n67", 0, 0, 738, 758, "SDL", 0, 0, 147600, 151600},
	"n70":  {"n70", 1695, 1710, 1995, 2020, "FDD", 339000, 342000, 399000, 404000},
	"n71":  {"n71", 663, 698, 617, 652, "FDD", 132600, 139600, 123400, 130400},
	"n72":  {"n72", 451, 456, 461, 466, "FDD", 90200, 91200, 92200, 93200},
	"n74":  {"n74", 1427, 1470, 1475, 1518, "FDD", 285400, 294000, 295000, 303600},
	"n75":  {"n75", 0, 0, 1432, 1517, "SDL", 0, 0, 286400, 303400},
	"n76":  {"n76", 0, 0, 1427, 1432, "SDL", 0, 0, 285400, 286400},
	"n77":  {"n77", 3300, 4200, 3300, 4200, "TDD", 620000, 680000, 620000, 680000},
	"n78":  {"n78", 3300, 3800, 3300, 3800, "TDD", 620000, 653333, 620000, 653333},
	"n79":  {"n79", 4400, 5000, 4400, 5000, "TDD", 693334, 733333, 693334, 733333},
	"n80":  {"n80", 1710, 1785, 0, 0, "SUL", 342000, 357000, 0, 0},
	"n81":  {"n81", 880, 915, 0, 0, "SUL", 176000, 183000, 0, 0},
	"n82":  {"n82", 832, 862, 0, 0, "SUL", 166400, 172400, 0, 0},
	"n83":  {"n83", 703, 748, 0, 0, "SUL", 140600, 149600, 0, 0},
	"n84":  {"n84", 1920, 1980, 0, 0, "SUL", 384000, 396000, 0, 0},
	"n85":  {"n85", 698, 716, 728, 746, "FDD", 139600, 143200, 145600, 149200},
	"n86":  {"n86", 1710, 1780, 0, 0, "SUL", 342000, 356000, 0, 0},
	"n89":  {"n89", 824, 849, 0, 0, "SUL", 164800, 169800, 0, 0},
	"n90":  {"n90", 2496, 2690, 2496, 2690, "TDD", 499200, 537999, 499200, 537999},
	"n91":  {"n91", 832, 862, 1427, 1432, "FDD", 166400, 172400, 285400, 286400},
	"n92":  {"n92", 832, 862, 1432, 1517, "FDD", 166400, 172400, 286400, 303400},
	"n93":  {"n93", 880, 915, 1427, 1432, "FDD", 176000, 183000, 285400, 286400},
	"n94":  {"n94", 880, 915, 1432, 1517, "FDD", 176000, 183000, 286400, 303400},
	"n95":  {"n95", 2010, 2025, 0, 0, "SUL", 402000, 405000, 0, 0},
	"n96":  {"n96", 5925, 7125, 5925, 7125, "TDD", 795000, 875000, 795000, 875000},
	"n97":  {"n97", 2300, 2400, 0, 0, "SUL", 460000, 480000, 0, 0},
	"n98":  {"n98", 1880, 1920, 0, 0, "SUL", 376000, 384000, 0, 0},
	"n99":  {"n99", 1626.5, 1660.5, 0, 0, "SUL", 325300, 332100, 0, 0},
	"n100": {"n100", 874.4, 880, 919.4, 925, "FDD", 174880, 176000, 183880, 185000},
	"n101": {"n101", 1900, 1910, 1900, 1910, "TDD", 380000, 382000, 380000, 382000},
	"n102": {"n102", 5925, 6425, 5925, 6425, "TDD", 795000, 828333, 795000, 828333},
	"n104": {"n104", 6425, 7125, 6425, 7125, "TDD", 828334, 875000, 828334, 875000},
	"n105": {"n105", 663, 703, 612, 652, "FDD", 132600, 140600, 122400, 130400},
	"n106": {"n106", 896, 901, 935, 940, "FDD", 179200, 180200, 187000, 188000},
	"n109": {"n109", 703, 733, 1432, 1517, "FDD", 140600, 146600, 286400, 303400},
	"n256": {"n256", 1980, 2010, 2170, 2200, "FDD", 396000, 402000, 434000, 440000},
	"n255": {"n255", 1626.5, 1660.5, 1525, 1559, "FDD", 325300, 332100, 305000, 311800},
	"n254": {"n254", 1610, 1626.5, 2483.5, 2500, "FDD", 322000, 325300, 496700, 500000},
}
